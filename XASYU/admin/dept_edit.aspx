<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dept_edit.aspx.cs" Inherits="XASYU.admin.dept_edit" %>
            ...
            <Items>
                <f:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server"
                    ...
                    <Items>
                        ...
                        <f:DropDownList ID="ddlParent" Label="上级部门" Required="true" ShowRedStar="true"
                            runat="server">
                        </f:DropDownList>
                         <f:TextBox ID="tbxDeptLeader" runat="server" Label="部门负责人" Required="true" ShowRedStar="true">
                        </f:TextBox>
                        <f:TextBox ID="tbxDeptTel" runat="server" Label="部门电话">
                        </f:TextBox>
