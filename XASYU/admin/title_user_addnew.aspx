<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="title_user_addnew.aspx.cs"
    Inherits="XASYU.admin.title_user_addnew" %>
...
<body>
    ...
    <f:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="5px"
         Layout="Fit">
        <Toolbars>
            <f:Toolbar ID="Toolbar1" runat="server">
                <Items>
                    ...
                    <f:TwinTriggerBox ID="ttbSearchMessage" Width="180px" runat="server" ShowLabel="false"
