<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_new.aspx.cs" Inherits="XASYU.admin.user_new" %>
                ...
                <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
                    ...
                    <Rows>
                        ...
                        <f:FormRow ID="FormRow6" runat="server">
                            <Items>
                                <f:DropDownList ID="ddlXL" runat="server"  Label="学历">
                                </f:DropDownList>
                                 <f:DropDownList ID="ddlXW" runat="server"  Label="学位">
                                </f:DropDownList>
                            </Items>
                        </f:FormRow>
                         <f:FormRow ID="FormRow4" runat="server">
                            <Items>
                                <f:DatePicker ID="date_stu_birth"    Label="出生日期" Required="true" ShowRedStar="true"   runat="server"></f:DatePicker>
                         ...
                         <f:FormRow ID="FormRow7" runat="server">
                            <Items>
                                <f:DropDownList ID="ddlPolitical" runat="server" Label="政治面貌">
                                </f:DropDownList>
                        ...
                        <f:FormRow ID="FormRow2" runat="server">
                            <Items>
                                <f:TriggerBox ID="tbSelectedDept" EnableEdit="false" EnablePostBack="false" TriggerIcon="Search"
                                    Label="所属部门" runat="server"  Required="true" ShowRedStar="true">
                                </f:TriggerBox>
                            </Items>
                        </f:FormRow>
