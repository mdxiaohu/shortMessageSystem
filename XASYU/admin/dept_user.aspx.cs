...
namespace XASYU.admin
{
    public partial class dept_user : PageBase
    {
        ...
        {
            List<SYS_DEPTSModel> mys = depHelp.Depts;
        ...
        private void BindGrid2()
        {
            ...
            else
            {
                ...
                {
                    UserModel.Name = this.ttbSearchUser.Text.Trim();
                }
                /*以上代码实现查询赋值*/
        ...
        protected void btnDeleteSelected_Click(object sender, EventArgs e)
        {
            ...
            {
                string strWhere = "ID="+ids;
                Common.UpdateTable("sys_Users", new string[] { "DeptID" }, new string[,] { { "null", "0" } }, strWhere);
            }
