<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmTABLE_SJXdxfs.aspx.cs" Inherits="XASYU.dxxt.frmTABLE_SJXdxfs" %>
            ...
            <Toolbars>
                <f:Toolbar ID="Toolbar1" runat="server">
                    <Items>
                        ...
                        <f:Button ID="Button1" ValidateForms="SimpleForm1" Icon="SystemSaveClose"
                            OnClick="btnSaveClose_Click1" runat="server" Text="发送短信">
                        </f:Button>
