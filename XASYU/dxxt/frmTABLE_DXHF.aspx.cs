...
{
    public partial class frmTABLE_DXHF : PageBase
    {
        #region 浏览权限
        /// <summary>
        ...
        private void LoadData()
        {
            ...
            btnNew.OnClientClick = Window1.GetShowReference("frmTABLE_DXHFNew.aspx", "");
        ...
        private void BindGrid()
        {
            try
            {
                ...
                {
                    model.DXHF_hfrmobile = this.ttbSearchMessage.Text.Trim();
                }
        ...
        protected DataTable GetDataTable()
        {
            ...
            DataSet ds = XASYU.BLL.DataBaseQuery.query_TABLE_DXHF(userBean, model, ref V_ITOTALCOUNT, V_SSTARTINDEX, V_SPERPAGESIZE);
        ...
        protected void btnDeleteSelected_Click(object sender, EventArgs e)
        {
            ...
            foreach (int id in ids)
            {
                ...
                XASYU.BLL.DataBaseManager.op_TABLE_DXHF(userBean, model);
            }
            // 重新绑定表格
        ...
        protected void Grid1_RowCommand(object sender, GridCommandEventArgs e)
        {
            ...
            {
                string URL = "~/frmTABLE_DXHFXQ.aspx?id=" + ID;
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=短信回复.xls");
