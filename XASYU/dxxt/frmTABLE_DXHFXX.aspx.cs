...
{
    public partial class frmTABLE_DXHFXX : PageBase
    {
        #region ViewPower
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (Request.QueryString["DXHF_ID"] != null && Request.QueryString["DXHF_ID"].ToString().Trim() != "")
                {
                    ...
                    if (ds != null && ds.Tables.Count > 0 && ds.Tables[0] != null && ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        lblhiddenDXHF_id.Text = dr["DXHF_id"].ToString();
                        lbltxtSMS_id.Text = dr["SMS_id"].ToString();
                        lbltxtDXHF_hfrmobile.Text = dr["DXHF_hfrmobile"].ToString();
                        lbltxtDXHF_nr.Text = dr["DXHF_nr"].ToString();
                        lbltxtDXHF_time.Text = dr["DXHF_time"].ToString();
                    }
                }
            }
        }
