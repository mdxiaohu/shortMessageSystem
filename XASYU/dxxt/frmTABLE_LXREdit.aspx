<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmTABLE_LXREdit.aspx.cs" Inherits="XASYU.dxxt.frmTABLE_LXREdit" %>
            ...
            <Items>
                <f:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server"
                    ...
                    <Items>
                                ...
                                <f:TextBox ID="txtLXR_sex" runat="server" Label="性别" ></f:TextBox>
