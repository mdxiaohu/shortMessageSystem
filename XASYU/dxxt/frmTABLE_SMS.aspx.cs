...
{
    public partial class frmTABLE_SMS : PageBase
    {
        #region 浏览权限
        /// <summary>
        ...
        private void LoadData()
        {
            ...
            btnNew.OnClientClick = Window1.GetShowReference("frmTABLE_SMSNew.aspx", "");
        ...
        private void BindGrid()
        {
            try
            {
                ...
                {
                    model.SMS_jsr = this.ttbSearchMessage.Text.Trim();
                }
        ...
        protected DataTable GetDataTable()
        {
            ...
            DataSet ds = XASYU.BLL.DataBaseQuery.query_TABLE_SMS(userBean, model, ref V_ITOTALCOUNT, V_SSTARTINDEX, V_SPERPAGESIZE);
        ...
        protected void btnDeleteSelected_Click(object sender, EventArgs e)
        {
            ...
            foreach (int id in ids)
            {
                ...
                XASYU.BLL.DataBaseManager.op_TABLE_SMS(userBean, model);
            }
            // 重新绑定表格
        ...
        protected void Grid1_RowCommand(object sender, GridCommandEventArgs e)
        {
            ...
            {
                string URL = "~/frmTABLE_SMSXQ.fx?id=" + ID;
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=短信存储.xls");
