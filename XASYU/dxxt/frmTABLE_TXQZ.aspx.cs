...
{
    public partial class frmTABLE_TXQZ : PageBase
    {
        #region 浏览权限
        /// <summary>
        ...
        private void LoadData()
        {
            ...
            btnNew.OnClientClick = Window1.GetShowReference("frmTABLE_TXQZNew.aspx", "");
        ...
        private void BindGrid()
        {
            try
            {
                ...
                {
                    model.TXQZ_name = this.ttbSearchMessage.Text.Trim();
                }
        ...
        protected DataTable GetDataTable()
        {
            ...
            DataSet ds = XASYU.BLL.DataBaseQuery.query_TABLE_TXQZ(userBean, model, ref V_ITOTALCOUNT, V_SSTARTINDEX, V_SPERPAGESIZE);
        ...
        protected void btnDeleteSelected_Click(object sender, EventArgs e)
        {
            ...
            foreach (int id in ids)
            {
                ...
                XASYU.BLL.DataBaseManager.op_TABLE_TXQZ(userBean, model);
            }
            // 重新绑定表格
        ...
        protected void Grid1_RowCommand(object sender, GridCommandEventArgs e)
        {
            ...
            {
                string URL = "~/frmTABLE_TXQZXQ.aspx?id=" + ID;
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment; filename=通讯群组.xls");
