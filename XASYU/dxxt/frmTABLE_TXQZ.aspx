<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmTABLE_TXQZ.aspx.cs" Inherits="XASYU.dxxt.frmTABLE_TXQZ" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>TABLE_TXQZ维护页面</title>
</head>
<body>
                ...
                <f:Form ID="Form2" runat="server" Height="36px" BodyPadding="5px" ShowHeader="false"
                    ...
                    <Rows>
                        <f:FormRow ID="FormRow1" runat="server">
                            <Items>
                                <f:TwinTriggerBox ID="ttbSearchMessage" runat="server" ShowLabel="false" EmptyText="在群组名中搜索"
				 ...
				 <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    ...
                    DataKeyNames="TXQZ_id" AllowSorting="true" OnSort="Grid1_Sort"  SortField="TXQZ_id"
                    SortDirection="DESC" AllowPaging="true" IsDatabasePaging="true" OnPreDataBound="Grid1_PreDataBound"
                    OnRowCommand="Grid1_RowCommand" OnPageIndexChange="Grid1_PageIndexChange">
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                <f:Button ID="btnNew" runat="server" Icon="Add" EnablePostBack="false" Text="新增群组信息">
                                </f:Button>                   
					...
					<Columns>
						<f:RowNumberField Width="35px" EnablePagingNumber="true" />
								<f:BoundField DataField="TXQZ_id" SortField="TXQZ_id" HeaderText="群组编号" Width="200px">
								</f:BoundField>
								<f:BoundField DataField="TXQZ_name" HeaderText="群组名" Width="200px">
								</f:BoundField>
								<f:BoundField DataField="TXQZ_sjid" HeaderText="上级群组" Width="200px">
								</f:BoundField>
                        <f:WindowField TextAlign="Center" Icon="Pencil" ToolTip="修改信息" Title="修改信息" 
                            WindowID="Window1" DataIFrameUrlFields="TXQZ_id" DataIFrameUrlFormatString="frmTABLE_TXQZEdit.aspx?TXQZ_ID={0}"
                            Width="50px" HeaderText="修改"  />
                        <f:WindowField TextAlign="Center" Icon="Information" ToolTip="查看详细信息" Title="查看详细信息"
                            WindowID="Window1" DataIFrameUrlFields="TXQZ_id" DataIFrameUrlFormatString="frmTABLE_TXQZXX.aspx?TXQZ_ID={0}"
