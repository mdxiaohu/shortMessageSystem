...
namespace XASYU.MODEL
{
    ...
    [Serializable]
    public class SYS_DEPTSModel:ICustomTree, IKeyID, ICloneable
    {
        ...
        public virtual SYS_DEPTSModel Parent { get; set; }
        public virtual ICollection<SYS_DEPTSModel> Children { get; set; }
        public virtual ICollection<SYS_USERSModel> Users { get; set; }

        public object Clone()
        {
            SYS_DEPTSModel dept = new SYS_DEPTSModel
            {
                ID = ID,
                Name = Name,
                Remark = Remark,
